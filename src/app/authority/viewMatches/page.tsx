              ...
              <tbody className="text-sm">
                {matches.length > 0 ? (
                  matches.map((match) => (
                    ...
                    >
                      <td className="px-4 py-2">{match.user?.name || "Unknown"}</td>
                     <td className="px-4 py-2">
                        {match.players?.map((p: any) => (
                          <span key={p.email}>{p.name}, </span>
                        )) || "Unknown"}
                      </td>
                      <td className="px-4 py-2 break-all">{match.game || "Unknown"}</td>
                      <td className="px-4 py-2">{match.court?.name}({match.venue?.name})</td>
